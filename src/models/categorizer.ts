...
export class Categorizer {
  static async categorizeDomain(domain: string, content?: string): Promise<CategoryResult> {
  ...
  private static async checkLLMSite(domain: string, content?: string): Promise<CategoryResult> {
  ...
  private static async checkGamingSite(domain: string, content?: string): Promise<CategoryResult> {
    const reasons: string[] = []
    let confidence = 0
  ...
  private static async checkProxySite(domain: string, content?: string): Promise<CategoryResult> {
    const reasons: string[] = []
    let confidence = 0
  ...
  private static async checkSocialMedia(domain: string, content?: string): Promise<CategoryResult> {
    const reasons: string[] = []
    let confidence = 0
  ...
  private static async checkSelfHarm(domain: string, content?: string): Promise<CategoryResult> {
    const reasons: string[] = []
    let confidence = 0
  ...
  private static async checkAdultContent(domain: string, content?: string): Promise<CategoryResult> {
    const reasons: string[] = []
    let confidence = 0
  ...
  private static async checkEducational(domain: string, content?: string): Promise<CategoryResult> {
    const reasons: string[] = []
    let confidence = 0
  ...
  private static async checkNews(domain: string, content?: string): Promise<CategoryResult> {
    const reasons: string[] = []
    let confidence = 0
  ...
  private static async checkShopping(domain: string, content?: string): Promise<CategoryResult> {
    const reasons: string[] = []
    let confidence = 0
  ...
  private static async checkStreaming(domain: string, content?: string): Promise<CategoryResult> {
    const reasons: string[] = []
    let confidence = 0
